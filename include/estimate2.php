			...
			<div class="columnBox2">
				<div class="columnBoxInner">
					<div class="designBox10 mB20">
						...
						<?php if( get_field('th_02_01') ) { ?>
						<p class="mT20">※2 <span class="red">グループ単位でのご注文になります。プランの人数分入力してください。</span></p>
						<p class="mT20">※3 お肉が国産黒毛和牛100g、イベリコ豚バニコカルビ100g、鶏肉100g、フランクフルト１本に変更です。<span class="red">グループ単位でのご注文になります。プランの人数分入力してください。</span></p>
						<?php } ?>
