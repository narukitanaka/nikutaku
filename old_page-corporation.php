...
<div id="main">
	<div id="contentsBox">
		...
		<div class="imgPic mB30"><img src="<?php echo get_template_directory_uri(); ?>/images/houjinn/dami.png"></div>


<!--
		<div class="columnBox3 designBox13 mB50">
			<div class="columnBoxInner boxWrap">
...
-->
		...
		<div class="designBox12 mB40">
			...
			<div class="right">
				...
				<p>アップグリルとしては、社員や社員の家族まで楽しむことができ、尚且つ一体化が生まれるそんな企画にしたいと考えました。</p>
		...
		<div class="designBox12 mB40">
			...
			<div class="right">
				<p>大阪府立K高校様にて3年生800名のバーベキュー大会を運営させていただきました。アップグリルとしては、家族まで楽しむことができた上に一体化が生まれるそんな企画になりました。<br><br></p>
